...
def trilaterate_pinger_position(p_lag_array): #obs: originaly x_estimate og y_estimate were taken in as arguments
        ...
        solution_vec = np.matmul(A_dot_A_T_inv, np.matmul(A_T,B)) #(A_T * A).invers() * A_T * B
...
def calculate_tdoa_matrices(TDOA_array):
        ...
        d_01 = param.PhysicalConstants.SOUND_SPEED * TDOA_port_starboard # * param.DSPConstants.SAMPLE_TIME #float32
        d_02 = param.PhysicalConstants.SOUND_SPEED * TDOA_port_stern #* param.DSPConstants.SAMPLE_TIME #float32
